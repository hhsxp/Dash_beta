...
def process_uploaded_files(piloto_content_str: str, sla_content_str: str) -> pd.DataFrame:
    ...
    try:
        ...
        df_sla_sel = df_sla[[
            "Chave", "HorasPrimeiraResposta_Original", "HorasResolucao_Original",
            "CumpriuSLA_Resolucao_Original", "CumpriuSLA_PrimeiraResposta_Original"
        ]]
        ...
        def check_sla_resp(row):
            sla2 = row.get("SLA_Horas_Primeira_Resposta")
